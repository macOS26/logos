...
struct StrokeStyle: Codable, Hashable {
    ...
    init(color: VectorColor = .black, width: Double = 1.0, placement: StrokePlacement = .center, dashPattern: [Double] = [], lineCap: CGLineCap = .butt, lineJoin: CGLineJoin = .miter, miterLimit: Double = 10.0) {
        self.color = color
        self.width = width
...
struct VectorShape: Codable, Hashable, Identifiable {
    ...
    mutating func updateBounds() {
        bounds = transformedPath.boundingBoxOfPath
    }
    ...
    static func rectangle(at origin: CGPoint, size: CGSize) -> VectorShape {
        ...
        return VectorShape(name: "Rectangle", path: path, geometricType: .rectangle, strokeStyle: StrokeStyle(), fillStyle: FillStyle(color: .white))
    }
    ...
    static func circle(center: CGPoint, radius: Double) -> VectorShape {
        ...
        return VectorShape(name: "Circle", path: path, geometricType: .circle, strokeStyle: StrokeStyle(), fillStyle: FillStyle(color: .white))
    }
