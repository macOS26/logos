...
struct DrawingCanvas: View {
    ...
    @State internal var dragUpdateCounter: Int = 0  // Counter to throttle coordinate updates (60fps)
    ...
    // DIRECT SELECTION SHAPE DRAGGING STATE
    @State internal var isDraggingDirectSelectedShapes = false  // When dragging whole shapes in direct selection mode
    ...
    // MARK: - Snap to Point State
    @State internal var currentSnapPoint: CGPoint? = nil // Current point being snapped to for visual feedback
    @State internal var currentShapeId: UUID? = nil // ID of the shape currently being drawn
