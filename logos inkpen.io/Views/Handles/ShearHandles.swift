...
struct ShearHandles: View {
    ...
    private var calculatedCenter: CGPoint {
        // Calculate the TRUE geometric centroid of the shape, not just bounds center
        return calculateShapeCentroid()
    }
    ...
    private func calculateShapeCentroid() -> CGPoint {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            let shapeCenter = calculateShapeCentroid()  // Use true geometric centroid
            Circle()
                ...
                .highPriorityGesture(
                    DragGesture(minimumDistance: 3)
                        .onChanged { value in
                            ...
                            let actualCenter = calculateShapeCentroid()  // Use true geometric centroid
    ...
    private func extractPathPoints() {
        ...
        let centroid = calculateShapeCentroid()
