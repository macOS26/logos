//
//  ShapeCreationFunctions.swift
//  logos inkpen.io
//
//  Shape creation utility functions
//
...
func createEquilateralTrianglePathWithGridSnapping(rect: CGRect, gridSpacing: Double, unit: MeasurementUnit) -> VectorPath {
        ...
        // Calculate triangle points and snap them to grid
        ...
        let bottomRightY = bottomLeftY // Same Y for both bottom points
