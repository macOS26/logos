...
#ifndef RVNGDUMMYPRESENTATIONGENERATOR_H
#define RVNGDUMMYPRESENTATIONGENERATOR_H
...
class REVENGE_GENERATORS_API RVNGDummyPresentationGenerator : public RVNGPresentationInterface
{
	// disable copying
...
#endif // RVNGDUMMYPRESENTATIONGENERATOR_H
