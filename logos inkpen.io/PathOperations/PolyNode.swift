...
public class PolyNode {
    ...
    public var contour: ClipperPath {
        return polygon
    }
...
extension PolyNode {
    ...
    public func addPolyNodeToPaths(polynode: PolyNode,  nt: NodeType, paths:inout ClipperPaths) {
        var match = true
        switch nt {
        case .open:
            return
...
extension PolyTree {
    ...
    public var openPaths: ClipperPaths {
    ...
    public var closedPaths: ClipperPaths {
        var result = ClipperPaths()
        addPolyNodeToPaths(polynode: self, nt: .closed, paths: &result)
        return result
    }
    
    public var paths: ClipperPaths {
        var result = ClipperPaths()
