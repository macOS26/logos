...
public class Clipper: ClipperBase {
    ...
    @discardableResult
    public func execute(clipType: ClipType, solution:inout ClipperPaths, subjFillType: PolyFillType, clipFillType: PolyFillType ) throws ->  Bool {
    ...
    private func buildResult(_ polyg:inout ClipperPaths) {
