...
public class Offsetter {
    ...
    private var destPolys = ClipperPaths()
    private var srcPoly = ClipperPath()
    private var destPoly = ClipperPath()
    private var normals = ClipperPath()
    ...
    public func addPath(_ path: ClipperPath, joinType: JoinType, endType: EndType) {
    ...
    public func addPaths(_ paths: ClipperPaths, joinType: JoinType, endType: EndType) {
        paths.forEach {
    ...
    public func execute(_ solution: inout ClipperPaths,  delta: CGFloat) throws {
