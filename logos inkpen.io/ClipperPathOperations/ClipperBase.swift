...
//        print("Clipper deinit.")
    ...
    @discardableResult
    public func addPath(_ pg: ClipperPath, _ polyType: PolyType, _ closed: Bool) -> Bool {
    ...
    @discardableResult
    public func addPaths(_ ppg: ClipperPaths, _ polyType: PolyType, _ closed: Bool) -> Bool {
        var result = false
